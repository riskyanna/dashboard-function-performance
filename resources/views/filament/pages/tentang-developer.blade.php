<x-filament-panels::page>
    <!-- Wrapper Utama agar Livewire tidak Error -->
    <div>
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-1">
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 flex flex-col items-center text-center">
                    <div class="relative w-32 h-32 mb-4">
                        <img src="{{ asset('images/riski-profile.jpg') }}" 
                             alt="Riski Ramadhan" 
                             class="w-full h-full rounded-full object-cover border-4 border-amber-500 shadow-lg"
                        >
                ...
                <div class="mt-6 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <span class="px-3 py-1 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-full text-xs font-medium">Filament v3</span>
                        <span class="px-3 py-1 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-full text-xs font-medium">Tailwind CSS</span>
                    </div>
                </div>
            </div>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-gradient-to-br from-amber-600 to-orange-700 rounded-xl shadow-lg p-8 text-white relative overflow-hidden">
                    ...
                    <div class="relative z-10">
                        ...
                        <p class="text-primary-50 leading-relaxed mb-6 font-medium text-lg">
                        ...
                        <div class="flex items-center justify-between pt-4 border-t border-white/20">
                            <div class="text-sm text-primary-100 flex items-center gap-2">
